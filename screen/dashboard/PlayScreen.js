...
export default class PlayScreen extends TrackPlayer.ProgressComponent {
  ...
  async togglePlayback() {
    ...
    if (currentTrack == null) {
      ...
      await UserAuthServices.AddSession(this.state.user.token, '1');
      ...
      TrackPlayer.getState().then(async value => {
        ...
        <View style={styles.slide}>
          ...
          <View style={styles.navBar}>
            <View style={styles.leftContainer}>
              <TouchableOpacity
                underlayColor="#FFFFF"
                onPress={() => this.backopen()}>
                <View style={{flexDirection: 'row'}}>
                  <Icon name="chevron-left" size={30} color="#1c2d41" />
                </View>
              </TouchableOpacity>
            </View>
            <Text
            ...
            <TouchableOpacity style={styles.rightContainer}>
              <Icon name="more-vertical" size={30} color="#1c2d41" />
            </TouchableOpacity>
          </View>
          ...
          <View style={{alignItems: 'center', flex: 1}}>
              ...
              <View style={{width: '80%'}}>
                <View style={{alignItems: 'center'}}>
                  <View style={styles.coverContainer}>
                    <Image
                      source={{
                        uri: `${
                          this.state.playlistmain[this.state.index].image
                        }`,
                      }}
                      style={styles.cover}
                    />
                ...
                <View style={{alignItems: 'center', marginTop: 20}}>
                  <Text
                    ...
                    {this.state.playlistmain[this.state.index].title}
                  </Text>
                  <Text style={[styles.text, {fontSize: 16, marginTop: 5}]}>
                    {this.state.playlistmain[this.state.index].duration} -{' '}
                    {this.state.playlistmain[this.state.index].voiceType} Voice
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <TouchableOpacity style={{marginLeft: 5, marginRight: 5}}>
                    <Image
                      source={require('../../assets/ic_shuffle_24px.png')}
                      style={{height: 40, resizeMode: 'contain', margin: 10}}
                    />
                  </TouchableOpacity>
                  <TouchableOpacity style={{marginLeft: 10, marginRight: 5}}>
                    <Image
                      source={require('../../assets/hart.png')}
                      style={{height: 40, resizeMode: 'contain', margin: 10}}
                    />
                  </TouchableOpacity>
                  <TouchableOpacity style={{marginLeft: 5, marginRight: 5}}>
                ...
                <View
                  ...
                  <Text style={[styles.textLight, styles.timeStamp]}>
                    {Moment.utc(this.state.position * 1000).format('m:ss')}
                  </Text>
                  <Text style={[styles.textLight, styles.timeStamp]}>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Image
                  source={require('../../assets/ic_skip_previous_48px.png')}
                  style={{height: 40, resizeMode: 'contain', margin: 10}}
                />
              </TouchableOpacity>
              <TouchableOpacity
              ...
              <TouchableOpacity
                ...
                <Image
                  source={require('../../assets/ic_skip_previous_right_48px.png')}
                  style={{height: 40, resizeMode: 'contain', margin: 10}}
                />
              </TouchableOpacity>
            </View>
