...
import { Tab, Tabs, StyleProvider ,TabHeading} from 'native-base';
                    ...
                    <View>
                       {
                         ...
                         <View style={{borderRadius:500,overflow:"hidden",backgroundColor:"#201F3E"}}>
                           <Image  source={{uri: `${this.state.user.profile}` }} style={{width:130,height:130,resizeMode: 'cover',overflow:"hidden"}} />
                         </View>
                      //    :this.state.selectedImage!=''?   <View style={{borderRadius:500,overflow:"hidden",backgroundColor:"#201F3E"}}>
                      //    <Image  source={{uri: `${this.state.selectedImage}` }} style={{width:130,height:130,resizeMode: 'cover',overflow:"hidden"}} />
                      //  </View>
                       :
                      ...
                      <Text style={{color:"#a4abb3",fontSize:15}}>{this.state.user.department.department}
                      </Text>
