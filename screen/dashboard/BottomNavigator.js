...
export default class BottomNavigator extends Component {
  ...
  async GetActivityList() {
    ...
    try {
      const {data} = await UserAuthServices.GetActivityAll(
        ...
        datalist.push(
          <TouchableOpacity
            ...
            style={{
              ...
              backgroundColor: '#E5D7FE',
              height: 60,
              margin: 5,
              justifyContent: 'center',
            }}
            onPress={() => {
              that.setState({item: item, isactivitylog: false});
              that.RBSheet.open();
            }}>
  ...
  clickdraver(string) {
    if (string == 'home' && !this.state.home) {
      ...
      this.setState({
        view: <ProfileScreen myprop={this} draweropen={this._drawer} />,
        home: false,
        feed: false,
        chat: false,
        profile: true,
      ...
      this.setState({
        view: <ChatListScreen myprop={this} draweropen={this._drawer} />,
        home: false,
        feed: false,
        chat: true,
        profile: false,
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    this.setState({
                      view: (
                        <HomeScreen myprop={this} draweropen={this._drawer} />
                      ),
                      home: true,
                      feed: false,
                      chat: false,
                  ...
                  <Image
                    style={{
                      width: 18,
                      height: 20,
                      tintColor: this.state.home ? '#201F3E' : '#babfc5',
                    }}
                  ...
                  <Text
                    style={{
                      ...
                      alignItems: 'center',
                      textAlign: 'center',
                      color: this.state.home ? '#201F3E' : '#babfc5',
                    }}>
                    Home
                  </Text>
                </TouchableOpacity>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    this.setState({
                      view: (
                        <FeedScreen myprop={this} draweropen={this._drawer} />
                      ),
                      home: false,
                      feed: true,
                      chat: false,
                  ...
                  <Image
                    style={{
                      width: 20,
                      height: 20,
                      tintColor: this.state.feed ? '#201F3E' : '#babfc5',
                    }}
                  ...
                  <Text
                    style={{
                      ...
                      alignItems: 'center',
                      textAlign: 'center',
                      color: this.state.feed ? '#201F3E' : '#babfc5',
                    }}>
                    Feed{' '}
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  <Image
                    ...
                    style={{
                      ...
                      width: 20,
                      height: 20,
                      tintColor: this.state.chat ? '#201F3E' : '#babfc5',
                    }}
                  ...
                  <Text
                    style={{
                      justifyContent: 'center',
                      alignItems: 'center',
                      color: this.state.chat ? '#201F3E' : '#babfc5',
                    }}>
                    Chat{' '}
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  <Image
                    ...
                    style={{
                      ...
                      width: 20,
                      height: 20,
                      tintColor: this.state.profile ? '#201F3E' : '#babfc5',
                    }}
                    containerStyle={{marginHorizontal: 16}}
                  />
                  ...
                  <Text
                    style={{
                      justifyContent: 'center',
                      alignItems: 'center',
                      color: this.state.profile ? '#201F3E' : '#babfc5',
                    }}>
                    Profile{' '}
                  </Text>
                </TouchableOpacity>
              ...
              <Overlay
                ...
                onClose={() => this.setState({isVisiblepayment: false})}
                closeOnTouchOutside
                containerStyle={{
                  ...
                  <View
                    ...
                    <TouchableHighlight
                      ...
                      onPress={() => {
                        ...
                        this.props.navigation.navigate('TakeBreath');
                      }}>
                      <Image
                        source={require('../../assets/take_a_breath.png')}
                        style={{
                          height: 45,
                          resizeMode: 'contain',
                          marginBottom: 10,
                    ...
                    <TouchableHighlight
                      ...
                      onPress={async () => {
                        ...
                        await UserAuthServices.AddTips(
                          this.state.user.token,
                          '1',
                        );
                      }}>
                    ...
                    <TouchableHighlight
                      ...
                      <Image
                        source={require('../../assets/get_help.png')}
                        style={{
                          height: 45,
                          resizeMode: 'contain',
                          marginBottom: 10,
              ...
              <Overlay
                visible={this.state.isactivitylog}
                onClose={() => this.setState({isactivitylog: false})}
                closeOnTouchOutside
                containerStyle={{
                  backgroundColor: '#00000099',
                }}
                ...
                <ScrollView style={styles.SplashScreen_RootView}>
                  <View style={{marginTop: 5, marginBottom: 10}}>
                    <Text style={{textAlign: 'center', color: '#A4ABB3'}}>
                      Here are some additional quick tips that can help when
                      feeling uneasy.
                    </Text>
                  </View>
