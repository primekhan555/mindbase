...
export default class SplashScreen extends Component//<{}>
{
 ...
 async componentDidMount(){
  ...
  OneSignal.init("9928e333-258c-4ac8-b0b2-80b8ef117ba7", {kOSSettingsKeyAutoPrompt : false, kOSSettingsKeyInAppLaunchURL: false, kOSSettingsKeyInFocusDisplayOption:2});
  ...
  async GetMoodList(user){
    try {
      ...
      const { data } = await UserAuthServices.GetActivityMood(value.token,moment().format('YYYY-MM-DD'),moment().format('YYYY-MM-DD'))
      console.log(data);
